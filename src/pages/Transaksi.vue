      ...
      <div class="absolute z-10 -top-14 right-0">
        ...
        <EasyDataTable v-if="getTransaksi.length" :headers="headers" :items="getTransaksi" class="capitalize">
            ...
            <template #expand="item">
                <div class="status__done px-11 py-2" v-if="item.status_transaksi == 'SELESAI'">
                    <div class="">
                        <h2 class="text-sm">{{ item.user.name }} <span class="font-bold uppercase">sudah melakukan pembayaran</span></h2>
                ...
                <div class="status_not_done px-11 py-4" v-else>
                    ...
                    <h3 class="text-sm mb-3" v-else>{{ item.user.name }}, <span class="font-bold uppercase">belum melakukan pembayaran</span></h3>
                    <form @submit.prevent="" class="w-96">
                        ...
                        <tw-button type="success" round @click="konfirmasi(item.user.id, item.kela.id, item.id)" v-if="item.bukti_transaksi_url">Konfirmasi</tw-button>
        ...
        >
          ...
          <div class="modal__content w-96">
            <DangerAlert :msg="msg.err" />
            <div class="flex">
              <tw-button type="primary" round class="w-full" @click="deleteTransaksi "
                >Hapus</tw-button
              >
