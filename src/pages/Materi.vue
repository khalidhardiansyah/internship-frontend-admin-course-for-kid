  ...
  <div class="flex flex-col">
    ...
    >
      <template #item-deskripsi_content="item">
        <span
          v-html="item.deskripsi_content.substr(0, 10)"
          @click="showDetails"
          v-if="show === false"
        ...
        <div class="cursor-pointer" @click="showDetails" v-else>
          <QuillEditor
            theme=""
            toolbar=""
            :content="item.deskripsi_content"
            contentType="html"
            readOnly
          />
        </div>
      ...
      <template #item-actions="item">
        <div class="whitespace-normal flex flex-row space-x-5">
          ...
          >
            <img
              src="../assets/icons8-edit-100.png"
              class="w-7"
              alt="edit"
              srcset=""
            />
      ...
      <template #expand="item">
        <div class="px-5 py-3">
          <iframe
            width="300"
            height="180"
            :src="`https://www.youtube.com/embed/${item.content}?controls=1`"
          >
          </iframe>
        </div>
      </template>
    ...
    <section
      class="h-80 max-h-80 rounded-xl flex flex-col items-center justify-center bg-purple-50"
      v-else
    >
      ...
      <tw-button class="mt-5" type="primary" round @click="openModal()"
